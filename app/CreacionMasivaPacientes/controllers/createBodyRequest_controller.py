...
async def create_body_request(paciente_data):
    try:
        ...
        paciente_body = {
            ...
            "firstGivenName": paciente_data["PRIMERNOMBRE"].upper(),
            "secondGivenName": paciente_data.get("SEGUNDONOMBRE", "").upper(),
            "firstFamilyName": paciente_data["PRIMERAPELLIDO"].upper(),
            "secondFamilyName": paciente_data.get("SEGUNDOAPELLIDO", "").upper(),
